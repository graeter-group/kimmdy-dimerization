...
k1 = 2.017017017017017  # self.config.k1  # Distance scaling [1/nm]
k2 = 0.03003003003003003  # self.config.k2  # Angle scaling [1/deg]
d0 = 0.157177  # self.config.d0  # Optimal distance [nm]
n0 = 16.743651884789273  # self.config.n0  # Optimal angle [deg]
...
for reactive_four in combinations(c5_c6s, r=2):
    dihedral_group = mda.AtomGroup([reactive_four[0][0], reactive_four[0][1], reactive_four[1][1], reactive_four[1][0]])
...
for ts_idx, ts in enumerate(universe.trajectory):
    vecs_c5_1_c5_2 = [(c5_1.resid, c5_2.resid, c5_2.position - c5_1.position) for c5_1, c5_2 in combinations(c5s, r=2)]
    vecs_c6_1_c6_2 = [(c6_1.resid, c6_2.resid, c6_2.position - c6_1.position) for c6_1, c6_2 in combinations(c6s, r=2)]
...
for time_idx, (distances, angles) in enumerate(zip(dists_time_resolved, dihedrals_time_resolved)):
    for distance, angle in zip(distances, angles):
        rates_time_resolved[time_idx].append((distance[0], distance[1], calculate_rate(k1, k2, d0, n0, distance[2], angle[2])))
